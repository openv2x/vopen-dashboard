...
public class ConfigActivity extends PreferenceActivity implements
  ...
  public static final String ENABLE_WIFI_KEY = "enable_wifi_preference";
  public static final String WIFI_IP_ADDR = "obd_ip_preference";
  public static final String WIFI_PORT_NUMBER = "obd_port_preference";

  /**
   * @param prefs
   * @return
   */
  public static String getObdIpAddr(SharedPreferences prefs) {
    String cmdsStr = prefs.getString(WIFI_IP_ADDR, "192.168.0.10");
    return cmdsStr;
  }
  /**
   * @param prefs
   * @return
   */
  public static int getObdPortNumber(SharedPreferences prefs) {
    String portString = prefs
            .getString(ConfigActivity.WIFI_PORT_NUMBER, "35000"); // 4 as in seconds
    int port = 35000; // by default 4000ms
